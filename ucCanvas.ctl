...
'================================================
' User control:  ucCanvas.ctl 2.0 (simplified)
' Author:        Carles P.V.
' Dependencies:  cDIB24.cls, [mGDIp.bas]*
' Last revision: 2003.07.05
'================================================
'
' * Only for high-quality functionality
'   See pvRefreshCanvas() sub
...
'-- Public objects:
Public DIB24 As cDIB24 ' DIB section
  ...
  Dim wSrc As Long, hSrc As Long
    ...
    If (Ambient.UserMode And Extender.Visible) Then
        ...
        If (DIB24.hDIB <> 0) Then
            ...
            '// DIB24.Stretch hDC, xOff, yOff, wDst, hDst, xSrc, ySrc, wSrc, hSrc //
            mGDIp.GdipStretchDIB DIB24, hDC, xOff, yOff, wDst, hDst, xSrc, ySrc, wSrc, hSrc
    ...
    With DIB24
        ...
        If (.hDIB <> 0) Then
            ...
            If (m_FitMode = 0) Then
              ...
              Else
                DIB24.GetBestFitInfo ScaleWidth, ScaleHeight, m_Left, m_Top, m_Width, m_Height, -1
            End If
...
Private Function pvDIBx(ByVal x As Long) As Long
    ...
    If (DIB24.hDIB <> 0) Then
        If (m_FitMode) Then
            pvDIBx = Int((x - m_Left) / (m_Width / DIB24.Width))
          Else
...
Private Function pvDIBy(ByVal y As Long) As Long
    ...
    If (DIB24.hDIB <> 0) Then
        If (m_FitMode) Then
            pvDIBy = Int((y - m_Top) / (m_Height / DIB24.Height))
          Else
